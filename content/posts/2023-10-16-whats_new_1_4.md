...
![Network Observability - Installed Operator]({page.image('whats_new_1_4/netobserv-installed-operator.png')})
...
<p align="center"><img src="{page.image('whats_new_1_4/managed_panels.png')}" alt="Managed panels" width="300"></p>
