...
![Network Observability - Installed Operator]({page.image('whats_new_1.4/netobserv-installed-operator.png')})
...
![eBPF Agent - Privileged]({page.image('whats_new_1.4/ebpf-agent-priv.png')})

<img src="{page.image('whats_new_1.4/ibm_z15_mainframe.png')}" alt="IBM Z" width="300" align="right">
...
![eBPF Agent - Privileged / Features]({page.image('whats_new_1.4/ebpf-agent-priv-features.png')})
...
![query option and filter]({page.image('whats_new_1.4/query_filter.png')})

The **Overview** tab has several new packet drop graphs, two of which are shown below.

![Overview - Packet drops]({page.image('whats_new_1.4/overview-drops.png')})
...
<p align="center"><img src="{page.image('whats_new_1.4/managed_panels.png')}" alt="Managed panels" width="300"></p>
...
<p float="left">
    <img src="{page.image('whats_new_1.4/table-drops.png')}" alt="Traffic flows - Packet drops" width="500" style="display: inline">
    <img src="{page.image('whats_new_1.4/topology-drops.png')}" alt="Traffic flows - Topology drops" width="400" style="display: inline">
</p>
...
![Overview - DNS]({page.image('whats_new_1.4/overview-dns.png')})
...
![Dashboards - Netobserv / Health]({page.image('whats_new_1.4/dashboards-netobserv-health.png')})

The dashboard under **NetObserv** was also changed to separate applications and infrastructure.

![Dashboards - Netobserv]({page.image('whats_new_1.4/dashboards-netobserv.png')})
...
![Overview - RTT]({page.image('whats_new_1.4/overview-rtt.png')})
...
![Traffic flows - RTT]({page.image('whats_new_1.4/table-rtt.png')})
...
<img src="{page.image('whats_new_1.4/swap_and_back_and_forth.png')}" alt="Swap and Back and Forth">
...
<p align="center"><img src="{page.image('whats_new_1.4/scope_slider.png')}" alt="scope slider" height="300" align="right"></p>
