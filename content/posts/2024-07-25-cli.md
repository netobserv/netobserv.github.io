...
layout: :theme/post
title: "NetObserv CLI"
description: "Network Observability On Demand"
...
![logo]({page.image('cli/cli_logo.png')})
...
![arch]({page.image('cli/cli_architecture.png')})
...
![flows]({page.image('cli/flow_table.png')})
...
![packets]({page.image('cli/packet_table.png')})
...
![pod]({page.image('cli/connectivity_scenario_pod.png')})
...
![cli dropped]({page.image('cli/connectivity_scenario_cli_dropped.png')})
...
![cli ok]({page.image('cli/connectivity_scenario_cli_ok.png')})
...
![cli live filter]({page.image('cli/connectivity_scenario_cli_live_filter.png')})

- And add as many keywords as you want by pressing enter:
![cli live filters]({page.image('cli/connectivity_scenario_cli_live_filters.png')})

- If your deployment involve some DNS resolution, you can switch to the DNS display and show latencies and errors:
Once you updated your policies, you can give another try to your route until you fix the issue:
![cli dns]({page.image('cli/connectivity_scenario_cli_dns.png')})
...
![cli packets]({page.image('cli/packet_capture_scenario_cli.png')})
...
![wireshark unencrypted packets]({page.image('cli/wireshark_unencrypted_pcap.png')})
...
![wireshark tls keylog]({page.image('cli/wireshark_tls_keylog.png')})
...
![mitm proxy]({page.image('cli/mitm_proxy.png')})
