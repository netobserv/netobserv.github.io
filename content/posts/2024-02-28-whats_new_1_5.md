...
![Network Observability Operator and APIs]({page.image('whats_new_1_5/noo-apis.png')})
...
![Loki client settings]({page.image('whats_new_1_5/loki_client_settings.png')})
...
![Console plugin configuration]({page.image('whats_new_1_5/console_plugin_configuration.png')})
...
![Processor configuration]({page.image('whats_new_1_5/processor_configuration.png')})
...
![Manage Panels]({page.image('whats_new_1_5/manage_panels.png')})
...
<img src="{page.image('whats_new_1_5/graph_type-donut.png')}" alt="donut graph" width="450"> <img src="{page.image('whats_new_1_5/graph_type-lines.png')}" alt="lines graph" width="450">
...
![single graph focus]({page.image('whats_new_1_5/single_graph_focus.png')})
...
![flow table - DSCP]({page.image('whats_new_1_5/flow_table-dscp.png')})
...
![flow table - Zone]({page.image('whats_new_1_5/flow_table-zone.png')})
...
![flow table - Cluster ID]({page.image('whats_new_1_5/flow_table-cluster_id.png')})
...
![Manage Columns]({page.image('whats_new_1_5/manage_columns.png')})
...
![Topology - Display options]({page.image('whats_new_1_5/topology-display_options.png')})
...
![filter]({page.image('whats_new_1_5/filter.png')})
