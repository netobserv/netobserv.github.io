...
![Traffic flows grayed out]({page.image('whats_new_1_6/traffic_flows-grayed_out.png')})
...
![Topology]({page.image('whats_new_1_6/topology-no_resources.png')})
...
![Loki client settings]({page.image('whats_new_1_6/flp-loki_client_settings.png')})
...
![Prometheus settings]({page.image('whats_new_1_6/flp-prometheus.png')})
...
![eBPF Agent statistics]({page.image('whats_new_1_6/ebpf_agent_statistics.png')})
...
![Disable alerts]({page.image('whats_new_1_6/ebpf_metrics_configuration.png')})
...
![Not 'ip' filter]({page.image('whats_new_1_6/not_ip_filter.png')})
...
![Subnet labels configuration]({page.image('whats_new_1_6/subnet_labels_configuration.png')})
...
![Subnet labels columns]({page.image('whats_new_1_6/subnet_labels_columns.png')})
...
![netobserv_cli]({page.image('whats_new_1_6/netobserv_cli.png')})
